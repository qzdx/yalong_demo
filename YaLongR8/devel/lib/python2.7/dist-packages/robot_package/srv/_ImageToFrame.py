...
"""autogenerated by genpy from robot_package/ImageToFrameRequest.msg. Do not edit."""
import codecs
import sys
...
class ImageToFrameRequest(genpy.Message):
  _md5sum = "d77936b4adceabd54a5fc3e51d5165bb"
  _type = "robot_package/ImageToFrameRequest"
...
string frame_id
"""
  __slots__ = ['image','armIndex','position']
  _slot_types = ['sensor_msgs/Image','int8','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageToFrameRequest, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.armIndex,) = _get_struct_b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robot_package/ImageToFrameResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ImageToFrameResponse(genpy.Message):
  _md5sum = "1850009fee622b55df0c6903f94f4582"
  _type = "robot_package/ImageToFrameResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float32[] terminal
int32 result
string strRt
"""
  __slots__ = ['terminal','result','strRt']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageToFrameResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_i():
    ...
    return _struct_i
class ImageToFrame(object):
  _type          = 'robot_package/ImageToFrame'
  _md5sum = '98dec61900beef2fa84144aa65b13d5c'
  _request_class  = ImageToFrameRequest
  _response_class = ImageToFrameResponse
