...
"""autogenerated by genpy from robot_package/MoveABSJActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveABSJActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "robot_package/MoveABSJActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_package/MoveABSJResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveABSJActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_package.msg.MoveABSJResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_package.msg.MoveABSJResult()
