...
(cl:defmethod cl:initialize-instance :after ((m <MoveJ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveJ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_package-srv:<MoveJ-request> is deprecated: use robot_package-srv:MoveJ-request instead.")))

(cl:ensure-generic-function 'arm_index-val :lambda-list '(m))
(cl:defmethod arm_index-val ((m <MoveJ-request>))
...
(cl:defmethod relative-val ((m <MoveJ-request>))
...
(cl:defmethod vel-val ((m <MoveJ-request>))
...
(cl:defmethod terminal-val ((m <MoveJ-request>))
...
(cl:defmethod cl:initialize-instance :after ((m <MoveJ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveJ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_package-srv:<MoveJ-response> is deprecated: use robot_package-srv:MoveJ-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <MoveJ-response>))
...
(cl:defmethod strRt-val ((m <MoveJ-response>))
